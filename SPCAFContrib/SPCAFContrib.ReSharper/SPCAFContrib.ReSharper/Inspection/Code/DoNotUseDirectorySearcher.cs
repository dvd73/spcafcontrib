...
{
    [ElementProblemAnalyzer(new[] { typeof(IObjectCreationExpression) }, HighlightingTypes = new[] { typeof(DoNotUseDirectorySearcherHighlighting) })]
    [Applicability(
        IDEProjectType.SP2010FarmSolution |
        IDEProjectType.SPSandbox |
        IDEProjectType.SP2013FarmSolution |
        IDEProjectType.SPServerAPIReferenced)]
    public class DoNotUseDirectorySearcher : ElementProblemAnalyzer<IObjectCreationExpression>
    {
                    ...
                    if (project.IsApplicableFor(this))
                    {
                        if (IsInvalid(element))
                        {
                            consumer.AddHighlighting(
                                new DoNotUseDirectorySearcherHighlighting(element),
        ...
        public static bool IsInvalid(IObjectCreationExpression element)
        {
            ...
            {
                result = element.IsOneOfType(new[] {ClrTypeKeys.DirectorySearcher});
            }
    ...
    public class DoNotUseDirectorySearcherHighlighting : IHighlighting
    {
        ...
        public DoNotUseDirectorySearcherHighlighting(IExpression element)
        {
