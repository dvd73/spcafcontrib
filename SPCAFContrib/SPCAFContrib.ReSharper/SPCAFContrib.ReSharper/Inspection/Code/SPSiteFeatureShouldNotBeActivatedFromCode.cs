...
namespace SPCAFContrib.ReSharper.Inspection.Code
{
    ...
    public class SPSiteFeatureShouldNotBeActivatedFromCode : ElementProblemAnalyzer<IReferenceExpression>
    {
                    ...
                    if (project.IsApplicableFor(this))
                    {
                        if (IsInvalid(element))
                        {
                            consumer.AddHighlighting(
                                new SPSiteFeatureShouldNotBeActivatedFromCodeHighlighting(element),
    ...
    public class SPSiteFeatureShouldNotBeActivatedFromCodeHighlighting : IHighlighting
    {
        ...
        public SPSiteFeatureShouldNotBeActivatedFromCodeHighlighting(IExpression element)
        {
