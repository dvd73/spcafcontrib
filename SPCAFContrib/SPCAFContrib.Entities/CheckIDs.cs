    ...
    public static class CheckIDs
    {
        ...
        public static class Rules
        {
            ...
            public static class General
            {
                ...
                public const string AvoidUsingUpdatePanel_HelpUrl = HelpSite.HelpPageUrl + "AvoidUsingUpdatePanel";
            }
            ...
            public static class FieldTemplate
            {
                ...
                public const string ConsiderOverwriteAttributeForField_HelpUrl = HelpSite.HelpPageUrl + ConsiderOverwriteAttributeForField + "_ConsiderOverwriteAttributeForFields";
                ...
                public const string UniqueFieldID = Prefix + "08";
                public const string UniqueFieldID_HelpUrl = HelpSite.HelpPageUrl + UniqueFieldID + "_UniqueFieldID";
                
                public const string UniqueFieldName = Prefix + "09";
                public const string UniqueFieldName_HelpUrl = HelpSite.HelpPageUrl + UniqueFieldName + "_UniqueFieldName";

                public const string UniqueFieldStaticName = Prefix + "10";
                public const string UniqueFieldStaticName_HelpUrl = HelpSite.HelpPageUrl + UniqueFieldStaticName + "_UniqueFieldStaticName";
            ...
            public static class Assembly
            {
                ...
                public const string UsingSPWebGetFilePreferable_HelpUrl = HelpSite.HelpPageUrl + UsingSPWebGetFilePreferable + "_UsingSPWebGetFilePreferable";
                ...
                public const string DoNotDeleteUserProfile_HelpUrl = HelpSite.HelpPageUrl + DoNotDeleteUserProfile + "_DoNotDeleteUserProfile";
                ...
                public const string OutOfContextSPWebPartManager_HelpUrl = HelpSite.HelpPageUrl + OutOfContextSPWebPartManager + "_OutOfContextSPWebPartManager";
