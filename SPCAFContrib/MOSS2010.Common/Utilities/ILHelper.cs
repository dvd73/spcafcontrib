...
namespace MOSS.Common.Utilities
{
    ...
    public class ILHelper
    {
        ...
        public static GenericSetter CreateSetMethod(Type targetType, String propName)
        {
            ...
            PropertyInfo propertyInfo = targetType.GetProperty(propName, BindingFlags.NonPublic | BindingFlags.Instance);
            ...
            if (propertyInfo != null)
            {
                ...
                if (setMethod != null)
                {
                    ...
                    DynamicMethod setter = new DynamicMethod(String.Concat("_Set", propertyInfo.Name, "_"),
