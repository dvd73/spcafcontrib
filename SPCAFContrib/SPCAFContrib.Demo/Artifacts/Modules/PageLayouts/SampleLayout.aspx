		 ...
		 <table class="full_width_table main_page_table">
		  <tr>                
				<td class="left_column">
					<WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="CenterLeft" Title="<%$Resources:cms,WebPartZoneTitle_CenterLeft%>" />
				</td>
                <td class="spacer_column">&nbsp;</td>
				<td class="middle_column">
					<WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="Center" Title="<%$Resources:cms,WebPartZoneTitle_Center%>" />
				</td>
                <td class="spacer_column">&nbsp;</td>
