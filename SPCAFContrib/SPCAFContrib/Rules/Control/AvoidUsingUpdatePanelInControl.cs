...
namespace SPCAFContrib.Rules.Control
{
    [RuleMetadata(typeof(ContribBestPracticesGroup),
     CheckId = CheckIDs.Rules.ASCXFile.AvoidUsingUpdatePanelInControl,
     Help = CheckIDs.Rules.General.AvoidUsingUpdatePanel_HelpUrl,

     Message = "Avoid using of UpdatePanel in the user contol [{0}].",
     DisplayName = "Avoid using of UpdatePanel in ASCX user control.",
    ...
    public class AvoidUsingUpdatePanelInControl : Rule<ASCXFile>
    {
        #region methods
