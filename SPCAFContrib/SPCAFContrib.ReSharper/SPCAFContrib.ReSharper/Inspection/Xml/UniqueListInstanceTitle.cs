...
namespace SPCAFContrib.ReSharper.Inspection.Xml
{
    ...
    public class UniqueListInstanceTitle : XmlTagProblemAnalyzer
    {
        public override void Run(IXmlTag element, IHighlightingConsumer consumer)
        {
            if (element.GetProject().IsApplicableFor(this))
            {
                ...
                {
                    UniqueListInstanceTitleHighlighting errorHighlighting =
                        new UniqueListInstanceTitleHighlighting(element);
        ...
        public static bool IsInvalid(IXmlTag element)
        {
            ...
            if (element.Header.ContainerName == "ListInstance")
            {
                if (element.AttributeExists("Title"))
                    result |= CheckElementAttribute(element, "Title");
            }
    ...
    public class UniqueListInstanceTitleHighlighting : XmlErrorHighlighting
    {
        ...
        public UniqueListInstanceTitleHighlighting(IXmlTag element) :
